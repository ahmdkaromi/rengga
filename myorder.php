<?php
  ...
  $query = mysqli_query($koneksi, "select * from data_transaksi where username='$username'");
?>
                        ...
                        <div class="col-md-3">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="#" class="card-link"><a class="btn btn-primary" href="#" role="button">Beri
                                            Penilaian</a>
                                    </a>
                                    <a href="aksi-ganti-status.php?id_transaksi=<?= $row['id_transaksi']; ?>" name="batalkan" class="btn btn-danger d-grid mt-2 <?php if($row['status'] != 'unfinished') echo "disabled"; ?>" onclick="return confirm('Anda yakin ingin membatalkan riwayat transaksi ini?');">Batalkan</a>
                                    <a href="aksi-hapus-order.php?id_transaksi=<?= $row['id_transaksi']; ?>" name="hapus" class="btn btn-danger d-grid mt-2 <?php if($row['status'] == 'unfinished') echo "disabled"; ?>" onclick="return confirm('Anda yakin ingin menghapus riwayat transaksi ini?');"><i class="bi bi-trash"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
