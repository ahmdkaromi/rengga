...
//   }
  ...
  $query = mysqli_query($koneksi, "select * from data_layanan where id_toko='$id_toko'");
  ...
  if(isset($_POST['nama_toko'])){
    ...
    $stmt = mysqli_prepare($koneksi, "update data_toko set nama_toko=?, email_toko=?, handphone_toko=?, kecamatan=?, kode_pos=?, detail_alamat=?, deskripsi_toko=? where username=?");
    mysqli_stmt_bind_param($stmt, 'ssssisss', $nama_toko, $email_toko, $handphone_toko, $kecamatan, $kode_pos, $detail_alamat, $deskripsi_toko, $username);
...
<!-- Awal Main Content -->
    <section id="konten-buka-toko">
        <div class="container buktok">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="file-field">
                                <div class="z-depth-1-half mb-4">
                                    <center><img src="photos/toko_photo/<?php echo $toko['foto_toko'] ?>" class="rounded img-fluid gambar_toko" alt="example placeholder"></center>
                                </div>
                        ...
                        <div class="col-md-7 offset-md-1">
                            <form action="edit-toko.php" method="POST">
                                ...
                                <input type="text" id="namatoko" placeholder="Nama Toko" name="nama_toko"  class="form-control" autocomplete="off" value="<?= $toko['nama_toko']; ?>" required><br>
                                <input type="email" id="email" placeholder="E-Mail" name="email_toko"  class="form-control" autocomplete="off" value="<?= $toko['email_toko']; ?>" required><br>
                                <input type="tel" id="nomortelepon" placeholder="Nomor Telepon" name="handphone_toko"  class="form-control" autocomplete="off" value="<?= $toko['handphone_toko']; ?>" required><br>   
                                ...
                                <select class="form-select" name="kecamatan" aria-label="Default select example" required>
                                    ...
                                    <option value="bobotsari" <?php if($toko['kecamatan'] == "bobotsari") echo "selected"; ?>>Bobotsari</option>
                                    <option value="bojongsari" <?php if($toko['kecamatan'] == "bojongsari") echo "selected"; ?>>Bojongsari</option>
                                    <option value="bukateja" <?php if($toko['kecamatan'] == "bukateja") echo "selected"; ?>>Bukateja</option>
                                    <option value="kaligondang" <?php if($toko['kecamatan'] == "kaligondang") echo "selected"; ?>>Kaligondang</option>
                                    <option value="kalimanah" <?php if($toko['kecamatan'] == "kalimanah") echo "selected"; ?>>Kalimanah</option>
                                    <option value="karanganyar" <?php if($toko['kecamatan'] == "karanganyar") echo "selected"; ?>>Karanganyar</option>
                                    <option value="karangjambu" <?php if($toko['kecamatan'] == "karangjambu") echo "selected"; ?>>Karangjambu</option>
                                    <option value="karangmoncol" <?php if($toko['kecamatan'] == "karangmoncol") echo "selected"; ?>>karangmoncol</option>
                                    <option value="karangreja" <?php if($toko['kecamatan'] == "karangreja") echo "selected"; ?>>Karangreja</option>
                                    <option value="kejobong" <?php if($toko['kecamatan'] == "kejobong") echo "selected"; ?>>Kejobong</option>
                                    <option value="kemangkon" <?php if($toko['kecamatan'] == "kemangkon") echo "selected"; ?>>Kemangkon</option>
                                    <option value="kertanegara" <?php if($toko['kecamatan'] == "kertanegara") echo "selected"; ?>>Kertanegara</option>
                                    <option value="kutasari" <?php if($toko['kecamatan'] == "kutasari") echo "selected"; ?>>Kutasari</option>
                                    <option value="mrebet" <?php if($toko['kecamatan'] == "mrebet") echo "selected"; ?>>Mrebet</option>
                                    <option value="padamara" <?php if($toko['kecamatan'] == "padamara") echo "selected"; ?>>Padamara</option>
                                    <option value="pengadegan" <?php if($toko['kecamatan'] == "pengadegan") echo "selected"; ?>>Pengadegan</option>
                                    <option value="purbalingga" <?php if($toko['kecamatan'] == "purbalingga") echo "selected"; ?>>Purbalingga</option>
                                    <option value="rembang" <?php if($toko['kecamatan'] == "rembang") echo "selected"; ?>>Rembang</option>
                                </select><br>
                                <input type="text" id="kodepos" placeholder="Kode Pos" name="kode_pos" value="<?= $toko['kode_pos']; ?>" class="form-control" autocomplete="off"><br>
                                <textarea id="detailalamat" name="detail_alamat" placeholder="Detail Alamat" class="form-control" rows="5" autocomplete="off" required><?= $toko['detail_alamat'] ?></textarea> <br>
                                <h4><b>Deskripsi Toko</b></h4><br>
                                <textarea id="deskripsitoko" name="deskripsi_toko" placeholder="Masukkan Deskripsi atau informasi mengenai toko"class="form-control" rows="5" cols="50" autocomplete="off" required><?= $toko['deskripsi_toko'] ?></textarea>
                                <br>
                                <section id="tombol">
                                    <center><button type="submit" name="buat_toko" class="btn btn-warning mb-3"><b>Simpan</b></button></center>
                                </section>
                            </form>
                        </div>
                    </div>
            ...
            <div>
               <a href="input-data-penyedia-jasa.php" class="btn btn-warning mt-3 mb-4">Tambah Layanan</a>
               <a href="daftar-order.php" class="btn btn-outline-dark ms-2 mt-3 mb-4">Daftar Order</a>
            </div>
            <div class="layanan">
               <?php foreach($query as $layanan){ ?>
                <a href="<?= "edit-data-penyedia-jasa.php?id_layanan=".$layanan['id_layanan']; ?>" class="text-decoration-none text-reset">
                    <div class="card mb-4" style="max-width: 800px;">
                        <div class="row g-0">
                            <div class="col-md-5">
                                <img src="photos/layanan_photo/<?php echo $layanan['foto_layanan'] ?>" class="img-fluid rounded-start gambar_layanan" alt="lesprivate1">
                            </div>
                            <div class="col-md-7">
                                <div class="card-body">
